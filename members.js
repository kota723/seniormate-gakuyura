...
function renderSingleMemberCard(member, isDetail) {
    ...
    if (isDetail) {
        ...
        <div class="member-card-detail" style="${cardStyle}">
            ...
            <div style="padding: 40px 50px; flex: 1; min-width: 300px; display: flex; flex-direction: column; justify-content: flex-start; background: #fff;">
        ...
        <a href="members.html?name=${encodeURIComponent(member.name)}" class="member-card" style="${cardStyle}" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
            ...
            <div style="padding: 24px;">
                ...
                ${member.hobbies ? `
                <div style="margin: 16px 0; padding: 12px; background-color: #fafbfc; border-left: 3px solid #6BAF92; border-radius: 4px;">
                ...
                ${member.message ? `
                <div style="margin-top: 16px; padding: 16px; background: linear-gradient(135deg, #e8f5f1 0%, #d4ebe4 100%); background-color: #e8f5f1; border-radius: 8px; font-style: italic; text-align: center;">
