...
async function renderPostList(container, filterCategory = 'all') {
    ...
    // On index page, always show fixed 3 items, no load more
    ...
    // On Index: fixed 3. On Blog Page: use displayedItems (initially 6, increases)
    const showCount = isIndex ? 3 : displayedItems;
